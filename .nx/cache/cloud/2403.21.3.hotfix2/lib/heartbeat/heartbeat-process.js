...
var require_nx_imports_light = __commonJS({
  "src/lib/utilities/nx-imports-light.ts"(exports) {
    ...
    try {
      try {
        const { output: output5 } = lightClientRequire("nx/src/utils/output");
        let workspaceRoot3;
        try {
        ...
        exports.output = output5;
      } catch (e) {
        const { output: output5 } = lightClientRequire(
...
var import_fs2, stripJsonComments, workspaceRoot2;
var init_get_cloud_options = __esm({
  "src/lib/utilities/get-cloud-options.ts"() {
    "use strict";
    import_fs2 = require("fs");
    stripJsonComments = require_strip_json_comments();
...
var require_iterate = __commonJS({
  "../../../node_modules/asynckit/lib/iterate.js"(exports, module2) {
    ...
    function iterate(list, iterator, state, callback) {
      ...
      state.jobs[key] = runJob(iterator, key, list[key], function(error, output5) {
...
function createApiAxiosInstance(options, timeout = 1e4) {
  ...
  if (options.customProxyConfigPath) {
    const { nxCloudProxyConfig } = require((0, import_path3.join)(
      process.cwd(),
...
var import_path3, output2, axios, AxiosException, error429Promise;
...
function getLatestCommitMessage() {
  try {
    const output5 = (0, import_child_process2.execSync)("git log -1 --pretty=%B", { encoding: "utf-8" });
    return output5.trim();
  } catch {
    return null;
  }
...
function getLatestCommitAuthor() {
  try {
    const output5 = (0, import_child_process2.execSync)("git log -1 --pretty=%aN", { encoding: "utf-8" });
    return output5.trim();
  } catch {
    return null;
  }
...
function getBranch2() {
  try {
    const output5 = (0, import_child_process2.execSync)("git branch --show-current", { encoding: "utf-8" });
    return output5.trim();
  } catch {
    return null;
  }
...
function getRef() {
  try {
    const output5 = (0, import_child_process2.execSync)("git rev-parse --abbrev-ref HEAD", {
      encoding: "utf-8"
    });
    return output5.trim();
  } catch {
...
var import_perf_hooks, performanceEntries, createMetricRecorder, mapRespToPerfEntry, RUNNER_FAILURE_PERF_ENTRY;
  ...
  "src/lib/core/api/run-group.api.ts"() {
    ...
    RunGroupApi = class {
      ...
      async createRunGroup(branch, runGroup, ciExecutionId, ciExecutionEnv, stopAgentsOnFailure, agentCount, stopAgentsAfter, distributeOn, commitSha, commitRef, affectedProjectRatio, envVars, requireExplicitCompletion = false, touchedProjects = []) {
        var _a;
        const recorder = createMetricRecorder("createRunGroup");
        try {
      ...
      async completeRunGroup(branch, runGroup, ciExecutionId, ciExecutionEnv) {
        var _a;
        const recorder = createMetricRecorder("completeRunGroup");
        try {
          const resp = await axiosMultipleTries(
